    ...
    return(
        <div className="NewBlog__container">
          ...
          <div className="NewBlog__paragraphs">
            ...
            <p>
            La animación es verdaderamente brillante, realista y muy creativa. Jamie Foxx y Tina Fey en particular hicieron grandes actuaciones de voz en los personajes de Joe Gardner y 22 respectivamente, es de destacar también la banda sonora de jazz de Jon Batiste. 
            </p>
            <p>
            Joe Gardner es el personaje principal de Soul. Él es un profesor de música en una escuela de Secundaria, sueña con dedicarse de lleno a la música y algún día tocar en importantes escenarios y 22 recibe su nombre porque fue el alma Número 22 creada.
            </p>
            <p>
